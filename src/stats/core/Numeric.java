...
/**
 * The {@code Numeric} class is used to store numeric data. The data can be
 * decimal and are stored with double precision. Like any other {@code Data}
...
public class Numeric extends Data {
    ...
    /**
     * The null value for {@code Numeric} class, the minimum of {@code double}
     * type.
     */
    ...
    /**
     * Default constructor for {@code Numeric} class. The content is initialized
     * with null value.
     */
    public Numeric() {
        this.data = NULL;
    ...
    /**
     * Constructor for {@code Numeric} class from value. The Numeric instance is
     * initialized with given {@code data} value.
     *
    ...
    /**
     * The function sets the content of the {@code Numeric} object parsing the
     * string representation. If empty string is given, null value is used for
     * the assignment.
     *
