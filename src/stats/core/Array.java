...
public class Array {
    ...
    /**
     * The function tells if the {@code index} argument is a valid index for the
     * {@code Array} object.
     *
    ...
    /**
     * The function adds a null element at the end of the {@code Array} object.
     */
    public void add() {
    ...
    /**
     * The function adds an element at the end of the {@code Array} object. The
    ...
    /**
     * The function inserts a null element at the beginning of the {@code Array}
     * object.
     *
     * @return true if successful, else false.
     */
    ...
    /**
     * The function inserts a given number of null elements to the {@code Array}
     * object at a specific position of the array.
     *
     * @param index the position of the insertion.
    ...
    /**
     * The function removes an element of the {@code Array} at a given position.
     *
    ...
    /**
     * The function sets an element of the {@code Array} object specified by the
     * index to null value.
     *
     * @param index the position inside the array.
     * @throws ArrayIndexOutOfBoundsException
