...
public class Array {
  ...
  public Array(String name) {
    ...
    if (name.isEmpty()) name = getUntitledName();
   ...
   * {@code Array} object. If no element is stored, {@code Data.UNDEFINED}
   * is returned.
   *
   * @return the data type of {@code Array} elements.
   */
  public int type() {
    if (array.isEmpty()) return Data.UNDEFINED;
  ...
  public boolean add(Data data, int number) {
    ...
    if (data.type() != this.type() && this.type() != Data.UNDEFINED)
      return false;
