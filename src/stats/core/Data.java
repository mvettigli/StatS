...
/**
 * The {@code Data} class is the common interface for every data type used for
 * data storage in StatS. It is an abstract class and each subclass must
...
public abstract class Data {
    ...
    /**
     * The function sets the content of the {@code Data} object to null value.
     * Because it is abstract, each subclass of {@code Data} must implement this
     * method.
     */
    ...
    /**
     * The method returns a deep copy of the {@code Data} object. Because it is
     * abstract, each subclass of {@code Data} must implement this method.
     *
