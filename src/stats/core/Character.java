...
/**
 * The {@code Character} class is used to store an alphanumeric data. It is a
 * subclass of {@code Data} and implements all abstract methods. Because the
 * data is stored as a String object, the interface is very similar to the
...
public class Character extends Data {
    ...
    /**
     * The function returns the content of the {@code Character} object. Because
     * the data is stored as {@code String}, the value returned is not a
     ...
     *
     * @return {@code DataType.CHARACTER}.
     */
    @Override
